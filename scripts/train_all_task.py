...
if __name__ == "__main__":
    ...
    template = "nohup python3 -u safe_behavior.py --expid {task}-baseline-seed{seed} --env {task} --seed {seed} --beta 0.2"

    train_instructions = runner.compose(template, [task, seed])
